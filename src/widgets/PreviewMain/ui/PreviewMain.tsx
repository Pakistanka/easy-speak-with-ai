export const PreviewMain=()=>{
    ...
    return <div>
        ...
        <section className="home-2 pb-30">-
            <div className="container">
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-[314px_410px_520px]  px-4 ">
                    <div className="flex flex-col justify-between h-[440px] border border-black rounded-[40px] p-4 ">
                        <img 
                        ...
                        <p className="text-[27px] font-bold">Pay with cryptocurrency</p>
                        <p>Effortless transactions: embrace the future of payment</p>
                    </div>
                    <div className="flex flex-col justify-between h-[440px] bg-[#2F2E41] rounded-[40px] p-6 text-white ">
                        <img 
                            src="/images/img-learn.webp" 
                            alt="Описание" 
                        />
                        <p className="text-[27px] font-bold">Learn languages anonymously</p>
                        <p>Experience the benefits of anonymous language learning.</p>
                    </div>
                    <div className="flex flex-col-reverse justify-between h-[440px] bg-[url('/images/img-wrapper.webp')] bg-cover bg-center rounded-[40px] p-6">
                        <img className="w-[240]"
                            src="/images/img-discover.webp" 
                            alt="Описание" 
                        />
                        <p className="text-[27px] font-bold">Discover the power of our app</p>
            ...
            <div className="container">
                <div className="text-3xl sm:text-2xl md:text-5xl lg:text-5xl pb-6">
                    ...
                    <div className="div grid grid-cols-1 gap-[40] sm:grid-cols-2 lg:grid-cols-3 px-4">
                        <div className="div">
                            <div className="ml-[150] mb-6 relative flex justify-center items-center w-[54px] h-[54px] text-white font-normal text-[36px] rounded-full border-[1] border-black bg-black before:absolute before:content-[''] before:w-[340px] before:h-[2] before:left-[76px] before:bg-gray-500">1</div>
                            <h3 className="text-[27px] font-bold pb-6">Join our language learning community today!</h3>
                        ...
                        <div className="div">
                            <div className="ml-[150] mb-6 relative flex justify-center items-center w-[54px] h-[54px] text-white font-normal text-[36px] rounded-full border-[1] border-black bg-black before:absolute before:content-[''] before:w-[340px] before:h-[2] before:left-[76px] before:bg-gray-500">2</div>
                            <h3 className="text-[27px] font-bold pb-6">Explore lessons and connect with the right match</h3>
                        ...
                        <div className="div">
                            <div className="ml-[150] mb-6 relative flex justify-center items-center w-[54px] h-[54px] text-white font-normal text-[36px] rounded-full border-[3px] border-black bg-black">3</div>
                            <h3 className="text-[27px] font-bold pb-6">Start your journey to learn a new language</h3>
