    ...
    return <div>
        <section className="home-1 py-15 text-center">
            <div className="container max-w-[1304px] mx-auto px-[19px] xl:px-0">
                <div className="lg:w-[1080] m-auto">
                    ...
                    <span className="text-(--color-span-e)">{t('titleSection1_letterE')}</span>
                    {t('titleSection1_middle')}
                    <span className="text-(--color-span-s)">{t('titleSection1_letterS')}</span>
                    {t('titleSection1_part2')}
                    </h1>
                    <p className='leading-[150%] pb-10 text-[21px]'>{t('descriptionSection1')}</p>
                    <Button variant="primary" size="figma_md">{t('buttongetStarted')}</Button>
                </div>
            </div>
        </section>
                ...
                <div className="grid gap-4 grid-cols-1 justify-items-center xl:grid-cols-[341px_413px_1fr] xl:justify-items-stretch">
                    <div className="flex flex-col w-full max-w-[352px] xl:max-w-none h-[355px] xl:h-[440px] bg-(--block-pay-background) border border-black rounded-[40px] px-5 py-5 text-(--block-pay-text)">
                        <img className='pb-8 w-[286] xl:w-[300] ' 
                            ...
                            alt="Описание" 
                        />
                        <p className="text-[21px] xl:text-[27px] font-bold pb-4 wrap-break-word">{t('blockPayTitle')}</p>
                        <p className='text-[16px] xl:text-[20px] wrap-break-word'>{t('blockPayDescription')}</p>
                    </div>
                    <div className="flex flex-col w-full max-w-[352px] xl:max-w-none h-[374px] xl:h-[440px] bg-(--block-learn-background) rounded-[40px] px-8 py-5 text-white">
                        <img className='pb-8'
                            ...
                            alt="Описание" 
                        />
                        <p className="text-[21px] xl:text-[27px] font-bold pb-4 wrap-break-word">{t('blockLearnTitle')}</p>
                        <p className='text-[16px] xl:text-[20px] wrap-break-word'>{t('blockLearnDescription')}</p>
                    </div>
                    <div className="grid grid-cols-1 w-full max-w-[352px] xl:max-w-none h-auto min-h-[402px] xl:h-[440px] bg-[url('/images/img-wrapper.webp')] bg-cover bg-center p-4 md:p-6 text-white rounded-[40px]">
                        <div className="row-1">
                            <p className="text-[21px] xl:text-[27px] font-bold wrap-break-word">{t('blockDiscoverTitle')}</p>
                        </div>
                        <div className="row-2">
                            <p className='pb-4 lg:pb-8 text-[16px] xl:text-[20px] wrap-break-word'>{t('blockDiscoverDescription')}</p>
                        </div>
                        <div className="row-3 grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-4 lg:gap-0">
                            ...
                            <div className="col-2 flex items-end justify-center lg:justify-start lg:pl-7 xl:pl-10 pb-2.5 text-center ">
                                <p className="w-full max-w-[110px] sm:max-w-[110px] lg:max-w-[210px] text-[16px] lg:text-[16px] xl:text-[21px] font-bold">{t('blockDiscoverBegin')}</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section className="home-3 pb-30">
            <div className="container max-w-[1304px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 px-[19px] lx:px-0">
                <div>
                    <h2 className="text-[27px] leading-[150%]  lg:text-5xl font-bold pb-6">{t('titleSection3')}</h2>
                    <p className='sm:text-[16px] lg:text-[21px] '>{t('descriptionSection3')}</p>
                </div>
                <div>
                    <img src="/images/phone-girl.webp" alt="icon" />
                </div>
